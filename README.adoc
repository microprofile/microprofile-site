...
This directory is filtered and copied to `/.elasticbeanstalk` in the root of the assembled ZIP archive. It is not part of the JAR. These files configure the deployment process to Elastic Beanstalk.
