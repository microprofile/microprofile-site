...
If you want to the GitHub integration to work, you will need a microprofile github access token, (link:https://github.com/blog/1509-personal-api-tokens[Documentation on how to do this]). Set the `microprofile_github_atoken` value in `src/main/resources/base.properties`
