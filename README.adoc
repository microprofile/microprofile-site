...
Checkout the demo application here: https://microprofile.io/
...
You can test your credentials by issuing this command, the output should list the environment:
```
jonathanfisher@odin ~/dev/microprofile-site $ eb list
* microprofile-io-env
```
