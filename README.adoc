...
You will need a microprofile github access token, (link:https://github.com/blog/1509-personal-api-tokens[Documentation on how to do this]). You can use this value as a environment value (*microprofile_github_atoken*) or
